...
- 解除限制：对禁止复制、禁止选择的网页，可注入脚本解除选择限制。
...
- 按住 `Ctrl/⌘` 双击左键：注入解除限制脚本，用于无法选中文字的页面。
...
按住 `Ctrl/⌘` 双击左键注入解除限制脚本。部分页面可能需要先聚焦页面正文再操作。

## 许可证

当前未声明许可证。如需对外开源发布，建议补充 `LICENSE` 文件，例如 MIT 或 Apache-2.0。
